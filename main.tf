...
resource "null_resource" "cloudability-setup10" {
  provisioner "local-exec" {
      command = <<EOF
        curl -X POST -k -H 'Content-Type: application/x-www-form-urlencoded' -H 'Authorization: Basic Yng6Yng=' -i 'https://iam.test.cloud.ibm.com/identity/token' \
       --data-urlencode "grant_type=refresh_token" \
...
resource "null_resource" "cloudability-setup20" {
  provisioner "local-exec" {
      command = <<EOF
        curl -X POST -k -H 'Content-Type: application/x-www-form-urlencoded' -H 'Authorization: Basic Yng6Yng=' -i 'https://iam.test.cloud.ibm.com/identity/token' \
       --data-urlencode "grant_type=refresh_token" \
...
resource "null_resource" "cloudability-setup29" {
  provisioner "local-exec" {
      command = <<EOF
        curl -X POST -k -H 'Content-Type: application/x-www-form-urlencoded' -H 'Authorization: Basic Yng6Yng=' -i 'https://iam.test.cloud.ibm.com/identity/token' \
       --data-urlencode "grant_type=refresh_token" \
...
resource "null_resource" "cloudability-setup30" {
  provisioner "local-exec" {
      command = <<EOF
        curl -X POST -k -H 'Content-Type: application/x-www-form-urlencoded' -H 'Authorization: Basic Yng6Yng=' -i 'https://iam.test.cloud.ibm.com/identity/token' \
       --data-urlencode "grant_type=refresh_token" \
...
resource "null_resource" "cloudability-setup31" {
  provisioner "local-exec" {
      command = <<EOF
        curl -X POST -k -H 'Content-Type: application/x-www-form-urlencoded' -H 'Authorization: Basic Yng6Yng=' -i 'https://iam.test.cloud.ibm.com/identity/token' \
       --data-urlencode "grant_type=refresh_token" \
...
resource "null_resource" "cloudability-setup32" {
  provisioner "local-exec" {
      command = <<EOF
        curl -X POST -k -H 'Content-Type: application/x-www-form-urlencoded' -H 'Authorization: Basic Yng6Yng=' -i 'https://iam.test.cloud.ibm.com/identity/token' \
       --data-urlencode "grant_type=refresh_token" \
...
resource "null_resource" "cloudability-setup34" {
  provisioner "local-exec" {
      command = <<EOF
        curl -X POST -k -H 'Content-Type: application/x-www-form-urlencoded' -H 'Authorization: Basic Yng6Yng=' -i 'https://iam.test.cloud.ibm.com/identity/token' \
       --data-urlencode "grant_type=refresh_token" \
...
resource "null_resource" "cloudability-setup35" {
  provisioner "local-exec" {
      command = <<EOF
        curl -X POST -k -H 'Content-Type: application/x-www-form-urlencoded' -H 'Authorization: Basic Yng6Yng=' -i 'https://iam.test.cloud.ibm.com/identity/token' \
       --data-urlencode "grant_type=refresh_token" \
...
resource "null_resource" "cloudability-setup36" {
  provisioner "local-exec" {
      command = <<EOF
        curl -X POST -k -H 'Content-Type: application/x-www-form-urlencoded' -H 'Authorization: Basic Yng6Yng=' -i 'https://iam.test.cloud.ibm.com/identity/token' \
       --data-urlencode "grant_type=refresh_token" \
